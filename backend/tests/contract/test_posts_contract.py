...
async def test_post_create_invalid_privacy(async_client: AsyncClient):
    token = await issue_access_token(async_client, "posts_contract_1@example.com", "posts_contract_1")
...
async def test_post_create_success(async_client: AsyncClient):
    token = await issue_access_token(async_client, "posts_contract_2@example.com", "posts_contract_2")
    response = await async_client.post(
        "/v1/posts",
        json={"privacy": "Public"},
        headers={"Authorization": f"Bearer {token}"},
...
async def test_get_me_posts_contract(async_client: AsyncClient):
    token = await issue_access_token(async_client, "posts_contract_3@example.com", "posts_contract_3")
...
async def test_get_user_posts_malformed_uuid(async_client: AsyncClient):
    token = await issue_access_token(async_client, "posts_contract_4@example.com", "posts_contract_4")
...
async def test_get_following_posts_contract(async_client: AsyncClient):
    token = await issue_access_token(async_client, "posts_contract_5@example.com", "posts_contract_5")
...
async def test_attachment_spotify_link_shape(async_client: AsyncClient, db_session: AsyncSession):
    ...
    token = await issue_access_token(async_client, "posts_contract_6@example.com", "posts_contract_6")
...
async def test_attachment_text_shape(async_client: AsyncClient, db_session: AsyncSession):
    ...
    token = await issue_access_token(async_client, "posts_contract_7@example.com", "posts_contract_7")
...
async def test_attachment_audio_file_shape(async_client: AsyncClient, db_session: AsyncSession):
    ...
    token = await issue_access_token(async_client, "posts_contract_8@example.com", "posts_contract_8")
...
async def test_attachment_nginx_default_url_signing(async_client: AsyncClient, db_session: AsyncSession):
    ...
    token = await issue_access_token(async_client, "posts_contract_9@example.com", "posts_contract_9")
...
async def test_attachment_cloudfront_override_url_signing(async_client: AsyncClient, db_session: AsyncSession):
    ...
    token = await issue_access_token(async_client, "posts_contract_10@example.com", "posts_contract_10")
