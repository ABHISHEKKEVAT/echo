...
async def test_music_search_rejects_empty_query(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_1@example.com", "music_contract_1")
...
async def test_music_search_rejects_whitespace_only_query(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_2@example.com", "music_contract_2")
    response = await async_client.post(
        "/v1/search/music",
        json={"q": "   "},
        headers={"Authorization": f"Bearer {token}"},
...
async def test_music_search_rejects_limit_below_min(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_3@example.com", "music_contract_3")
    response = await async_client.post(
        "/v1/search/music",
        json={"q": "test", "limit": 0},
        headers={"Authorization": f"Bearer {token}"},
...
async def test_music_search_rejects_limit_above_max(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_4@example.com", "music_contract_4")
    response = await async_client.post(
        "/v1/search/music",
...
async def test_music_search_success_response_shape(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_5@example.com", "music_contract_5")
    with patch(
...
async def test_music_search_no_match_returns_empty_arrays(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_6@example.com", "music_contract_6")
    with patch(
        "backend.presentation.api.v1.music_search.MusicSearchUseCase.search",
        new_callable=AsyncMock,
...
async def test_music_search_partial_response_shape(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_7@example.com", "music_contract_7")
    with patch(
        "backend.presentation.api.v1.music_search.MusicSearchUseCase.search",
        new_callable=AsyncMock,
...
async def test_music_search_both_unavailable_returns_503(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_8@example.com", "music_contract_8")
    with patch(
        "backend.presentation.api.v1.music_search.MusicSearchUseCase.search",
        new_callable=AsyncMock,
...
async def test_music_search_accepts_punctuation_and_non_latin(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_9@example.com", "music_contract_9")
    with patch(
        "backend.presentation.api.v1.music_search.MusicSearchUseCase.search",
        new_callable=AsyncMock,
...
async def test_music_search_item_has_required_fields(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_10@example.com", "music_contract_10")
    with patch(
        "backend.presentation.api.v1.music_search.MusicSearchUseCase.search",
        new_callable=AsyncMock,
...
async def test_music_search_summary_has_source_statuses(async_client: AsyncClient):
    token = await issue_access_token(async_client, "music_contract_11@example.com", "music_contract_11")
    with patch(
        "backend.presentation.api.v1.music_search.MusicSearchUseCase.search",
        new_callable=AsyncMock,
        return_value=_make_full_response(),
...
async def test_music_search_domain_validation_error_returns_422(async_client: AsyncClient):
    ...
    token = await issue_access_token(async_client, "music_contract_12@example.com", "music_contract_12")
    with patch(
        "backend.presentation.api.v1.music_search.MusicSearchUseCase.search",
        new_callable=AsyncMock,
