...
async def test_non_friend_cannot_send_message(async_client: AsyncClient):
    token_a = await issue_access_token(async_client, "msg_a@example.com", "msg_a")
    token_b = await issue_access_token(async_client, "msg_b@example.com", "msg_b")
...
async def test_friends_can_send_and_list_messages(async_client: AsyncClient):
    token_a = await issue_access_token(async_client, "msg_friend_a@example.com", "msg_friend_a")
    token_b = await issue_access_token(async_client, "msg_friend_b@example.com", "msg_friend_b")
