...
async def test_get_user_profile_malformed_uuid(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_c1@example.com", "prof_c1")
...
async def test_get_user_profile_not_found(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_c2@example.com", "prof_c2")
    response = await async_client.get(
...
async def test_get_user_profile_200_shape(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_c3@example.com", "prof_c3")
...
async def test_search_users_returns_matching_users(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_s1@example.com", "prof_s1")
    await issue_access_token(async_client, "prof_s2@example.com", "prof_s2_match")
...
async def test_get_me_200_shape(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_c4@example.com", "prof_c4")
...
async def test_get_me_403_disabled(async_client: AsyncClient):
    ...
    token = await issue_access_token(async_client, "prof_c5@example.com", "prof_c5")
...
async def test_patch_me_empty_payload_422(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_c6@example.com", "prof_c6")
...
async def test_patch_me_non_mutable_email_422(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_c7@example.com", "prof_c7")
    response = await async_client.patch(
        "/v1/me",
...
async def test_patch_me_non_mutable_status_422(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_c8@example.com", "prof_c8")
    response = await async_client.patch(
        "/v1/me",
        json={"status": "active"},
        headers={"Authorization": f"Bearer {token}"},
...
async def test_patch_me_non_mutable_is_artist_422(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_c9@example.com", "prof_c9")
    response = await async_client.patch(
        "/v1/me",
        json={"is_artist": True},
        headers={"Authorization": f"Bearer {token}"},
...
async def test_patch_me_non_mutable_password_hash_422(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_c10@example.com", "prof_c10")
    response = await async_client.patch(
        "/v1/me",
...
async def test_patch_me_success_200_shape(async_client: AsyncClient):
    token = await issue_access_token(async_client, "prof_c11@example.com", "prof_c11")
    response = await async_client.patch(
        "/v1/me",
        json={"bio": "New bio"},
        headers={"Authorization": f"Bearer {token}"},
...
async def test_patch_me_username_conflict_409(async_client: AsyncClient):
    token_a = await issue_access_token(async_client, "prof_c12a@example.com", "prof_c12a")
    await issue_access_token(async_client, "prof_c12b@example.com", "prof_c12b")
